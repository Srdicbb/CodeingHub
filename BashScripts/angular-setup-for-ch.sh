...
ng new "$PROJECT_NAME" --style=scss --skip-install=false
...
# kreirati obican projekat sa ng new CodeingHub.Ui mozes podeiti da li hoces da napravi standalone ili ne
# Ako hoces da napravis standalone komponentu, mozes dodati --standalone flag 
# HOcemo SCSS ali necu SSR i to bi trebalo da bude to